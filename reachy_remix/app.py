    ...
    with gr.Blocks(title="🧪 Reachy Mini Lab") as app:
        ...
        with gr.Column(elem_classes=["compact-container"]):
            ...
            with gr.Row(elem_classes=["btn-grid"]):
                ...
                btn_look = gr.Button(value="👀 Side Glance Flick", elem_classes=["move-btn"], size="lg")
                btn_happy = gr.Button(value="😊 Groovy Sway And Roll", elem_classes=["move-btn"], size="lg")
                btn_excited = gr.Button(value="🎉 Side To Side Sway", elem_classes=["move-btn"], size="lg")
            with gr.Row(elem_classes=["btn-grid"]):
                ...
                btn_shrug = gr.Button(value="⚡ Sharp Side Tilt", elem_classes=["move-btn"], size="lg")
                btn_think = gr.Button(value="🔄 Head Tilt Roll", elem_classes=["move-btn"], size="lg")
                btn_celebrate = gr.Button(value="⏱️ Pendulum Swing", elem_classes=["move-btn"], size="lg")
            ...
            with gr.Row(elem_classes=["btn-grid"]):
                ...
                btn_heart = gr.Button(value="👻 Side Peekaboo", elem_classes=["move-btn"], size="lg")
                btn_cool = gr.Button(value="🎸 Headbanger Combo", elem_classes=["move-btn"], size="lg")
                btn_surprise = gr.Button(value="😵 Stumble And Recover", elem_classes=["move-btn"], size="lg")
