...
class MotionEngine:
    ...
    def execute_move(self, move_id: str) -> bool:
        ...
        try:
            ...
            # Play move using ReachyMini directly
            self.robot.play_move(move, initial_goto_duration=1.0)
...
def create_app(robot=None, controller=None):
    """Create and configure the Gradio application.
    
    Args:
        robot: ReachyMini instance (None for demo mode)
    ...
    # Initialize motion engine with provided robot/controller
    ...
    with gr.Blocks(title="🧪 Reachy Mini Lab") as app:
        ...
        with gr.Column(elem_classes=["compact-container"]):
            ...
            with gr.Row(elem_classes=["btn-grid"]):
                btn_nod = gr.Button(value="👍 simple_nod", elem_classes=["move-btn"], size="lg")
                btn_shake = gr.Button(value="😄 yeah_nod", elem_classes=["move-btn"], size="lg")
                btn_wave = gr.Button(value="👋 uh_huh_tilt", elem_classes=["move-btn"], size="lg")
                btn_look = gr.Button(value="👀 side_glance_flick", elem_classes=["move-btn"], size="lg")
                btn_happy = gr.Button(value="😊 groovy_sway_and_roll", elem_classes=["move-btn"], size="lg")
                btn_excited = gr.Button(value="🎉 side_to_side_sway", elem_classes=["move-btn"], size="lg")
            with gr.Row(elem_classes=["btn-grid"]):
                btn_spin = gr.Button(value="🌀 dizzy_spin", elem_classes=["move-btn"], size="lg")
                btn_bow = gr.Button(value="🐔 chicken_peck", elem_classes=["move-btn"], size="lg")
                btn_shrug = gr.Button(value="⚡ sharp_side_tilt", elem_classes=["move-btn"], size="lg")
                btn_think = gr.Button(value="🔄 head_tilt_roll", elem_classes=["move-btn"], size="lg")
                btn_celebrate = gr.Button(value="⏱️ pendulum_swing", elem_classes=["move-btn"], size="lg")
                btn_sleep = gr.Button(value="😲 neck_recoil", elem_classes=["move-btn"], size="lg")
            with gr.Row(elem_classes=["btn-grid"]):
                btn_dance = gr.Button(value="💃 jackson_square", elem_classes=["move-btn"], size="lg")
                btn_robot = gr.Button(value="📐 grid_snap", elem_classes=["move-btn"], size="lg")
                btn_star = gr.Button(value="⭐ chin_lead", elem_classes=["move-btn"], size="lg")
                btn_heart = gr.Button(value="👻 side_peekaboo", elem_classes=["move-btn"], size="lg")
                btn_cool = gr.Button(value="🎸 headbanger_combo", elem_classes=["move-btn"], size="lg")
                btn_surprise = gr.Button(value="😵 stumble_and_recover", elem_classes=["move-btn"], size="lg")
...
if __name__ == "__main__":
    ...
    if SDK_AVAILABLE:
        ...
        if daemon_running:
            ...
            try:
                # Try to connect to robot through SDK
                from reachy_mini import ReachyMini
                robot = ReachyMini()
    ...
    print("  - 18 moves mapped to Reachy SDK")
